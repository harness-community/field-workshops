...
> **Policy Name**
> - Name: <pre>`Restrict Azure VM Instance Size`</pre>
> - Store: `Inline`
> - Click **Apply**
...
allowed_instance_types := {"Standard_B1s", "Standard_B1ms", "Standard_B2s"}
...
> **Policy Set**
> - **Overview**
>   - Name: <pre>`Prevent Non Standard Azure Instance Sizes`</pre>
...
>   - Click `+Add Policy`
>   - **Select Policy**
>     - Policy to Evaluate: `Restrict Azure VM Instance Size`
...
> - Change the value to <pre>`Standard_D8s_v5`</pre>
